...
def calculate_demographic_data(print_data=True):
    ...
    bachelors = len(df[(df['education'] == 'Bachelors') & (df['salary'] == '>50K')])
    masters = len(df[(df['education'] == 'Masters') & (df['salary'] == '>50K')])
    doctorates = len(df[(df['education'] == 'Doctorate') & (df['salary'] == '>50K')])
